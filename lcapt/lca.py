...
class _LCAConvBase(torch.nn.Module):
    def __init__(
        ...
        self.metric_fpath = os.path.join(self.result_dir, "metrics.csv")
    ...
    def _create_trackers(self) -> dict[str, np.ndarray]:
        ...
        return {
            ...
            "TimesActiveByFeature": [[]]*self.lca_iters
        }
    ...
    def _update_tracks(
        ...
        tracks["TimesActiveByFeature"][lca_iter - 1] = torch.squeeze(compute_times_active_by_feature(acts)).tolist()
        return tracks
