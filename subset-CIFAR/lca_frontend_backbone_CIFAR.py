...
# Model
model_name = "LCA Frontend + Scratchmodel CIFAR"                # model architecture which shall be used
...
# paths
model_dir = stem_dir + "/models/_params/subset-CIFAR/lca_frontend_backbone/" + f"_lr_{lr}_eta_{eta}_lambda_{LAMBDA}_ftr_{FEATURES}_size_{KERNEL_SIZE}_stride_{STRIDE}" + ".pt"
result_dir = stem_dir + "/models/_params/subset-CIFAR/lca_frontend_backbone/" + f"_lr_{lr}_eta_{eta}_lambda_{LAMBDA}_ftr_{FEATURES}_size_{KERNEL_SIZE}_stride_{STRIDE}"

fig_path = stem_dir + "/figures/subset-CIFAR/lca_frontend_backbone/"
fig_path_inference = stem_dir + "/figures/subset-CIFAR/lca_frontend_backbone/Inference_" +  f"_lr_{lr}_bs_{batch_size}" + ".png"
fig_path_acc = stem_dir + "/figures/subset-CIFAR/lca_frontend_backbone/Acc_over_epochs_lca_frontend" + f"_lr_{lr}_eta_{eta}_lambda_{LAMBDA}_ftr_{FEATURES}_size_{KERNEL_SIZE}_stride_{STRIDE}" + ".png"
fig_path_loss = stem_dir + "/figures/subset-CIFAR/lca_frontend_backbone/Loss_over_epochs" + f"_lr_{lr}_eta_{eta}_lambda_{LAMBDA}_ftr_{FEATURES}_size_{KERNEL_SIZE}_stride_{STRIDE}" + ".png"
...
LCA_model_path = stem_dir + "/models/_params/subset-CIFAR/" + "lca_dict" + f"_lr_0.001_eta_{eta}_lambda_{TRAIN_LAMBDA}_ftr_{FEATURES}_size_{KERNEL_SIZE}_stride_{STRIDE}_iters_{LCA_ITERS}_tau_{TAU}" + ".pt"
scratchmodel_path = stem_dir + "/models/_params/subset-CIFAR/backbone_CIFAR/" + f"backbone_CIFAR_lr_{lr}_bs_{batch_size}" + ".pt"
