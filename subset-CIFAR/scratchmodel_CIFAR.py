# -*- coding: utf-8 -*-
# This script train ResNet18 from scratch with CIFAR-10 subset dataset
# %%
import random
import sys
...
# Model
model_name = "Scratch CIFAR"                            # model architecture which shall be used
...
model_dir = stem_dir + "/models/_params/subset-CIFAR/scratchmodel_CIFAR/" + f"scratchmodel_CIFAR_lr_{lr}_bs_{batch_size}" + ".pt"

fig_path_cm = stem_dir + "/figures/subset-CIFAR/scratchmodel_CIFAR/conf_matrix_" + f"basemodel_lr_{lr}_bs_{batch_size}" +  ".png"
fig_path_acc = stem_dir + "/figures/subset-CIFAR/scratchmodel_CIFAR/Acc_over_epochs_" + f"basemodel_lr_{lr}_bs_{batch_size}" + ".png"
fig_path_loss = stem_dir +"/figures/subset-CIFAR/scratchmodel_CIFAR/Loss_over_epochs_" + f"basemodel_lr_{lr}_bs_{batch_size}" + ".png"
fig_path_inference = stem_dir + "/figures/subset-CIFAR/scratchmodel_CIFAR/Inference_" +  f"basemodel_lr_{lr}_bs_{batch_size}" + ".png"
