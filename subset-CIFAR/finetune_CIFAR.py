...
# this script fine tunes it with CIFAR-10 subset dataset for 10 classes 48%
# %%
import random
import sys
...
model_dir = stem_dir + "/models/_params/subset-CIFAR/finetune_CIFAR/" + f"finetune_CIFAR_lr_{lr}_bs_{batch_size}" + ".pt"
os.makedirs(os.path.dirname(model_dir), exist_ok=True)

fig_path_cm = stem_dir + "/figures/subset-CIFAR/finetune_CIFAR/conf_matrix_" + f"pretrained_lr_{lr}_bs_{batch_size}" +  ".png"
fig_path_acc = stem_dir + "/figures/subset-CIFAR/finetune_CIFAR/Acc_over_epochs_" + f"pretrained_lr_{lr}_bs_{batch_size}" + ".png"
fig_path_loss = stem_dir +"/figures/subset-CIFAR/finetune_CIFAR/Loss_over_epochs_" + f"pretrained_lr_{lr}_bs_{batch_size}" + ".png"
fig_path_inference = stem_dir + "/figures/subset-CIFAR/finetune_CIFAR/Inference_" +  f"pretrained_lr_{lr}_bs_{batch_size}" + ".png"
